    ...
    " role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a href="cpanel.php" class="navbar-brand headerFont text-lg"><strong>Poll</strong></a>
        </div>
          ...
          <div class="col-sm-12">
            <?php
              ...
              else
              {
                ...
                //BJP
                $sql ="SELECT * FROM tbl_users WHERE voted_for='A'";
                ...
                // CONGRESS
                $sql ="SELECT * FROM tbl_users WHERE voted_for='B'";
                $result= mysqli_query($conn, $sql);
                ...
                // AAP
                $sql ="SELECT * FROM tbl_users WHERE voted_for='C'";
                $result= mysqli_query($conn, $sql);
                ...
                // TMC
                $sql ="SELECT * FROM tbl_users WHERE voted_for='D'";
                $result= mysqli_query($conn, $sql);
